...
-- {{{ 
--mocpwidget = mocp.init(settings.theme_path.."/music/sonata.png")
--mocpwidget.width = 100 
-- }}} 
...
for s = 1, screen.count() do
	...
	baticon.image and separator, batwidget, baticon or nil, spacer, separator, spacer,
	cpuwidget.widget, spacer, separator, spacer,
	memwidget.widget, spacer, separator, spacer,
--	mocpwidget, spacer, separator, spacer,
        volumecfg.widget, spacer, separator, spacer,
	pomodoro(), spacer, separator, spacer,
